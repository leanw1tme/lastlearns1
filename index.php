        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card" style="border: 2px solid #6495ED; background:  linear-gradient(to bottom, #6495ED 50%, #fff 50%);">
              ...
              <div class="card info-card sales-card" style="border: 2px solid #6495ED; background:  linear-gradient(to bottom, #6495ED 50%, #fff 50%);">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-text"><span>Тут описание какого то урока</span></h5></a>
                          ...
                          <!-- Card -->
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card" style="border: 2px solid #FFD700; background:  linear-gradient(to bottom, #FFD700 50%, #fff 50%);">
